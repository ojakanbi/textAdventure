public class Main {
    public static void main(String[] args) {
        ...
        Ogre greenOgre = new Ogre(); // new object of Ogre initialized
        Ogre redOgre = new Ogre(); // new object of Ogre initialized
        ...
        Wolf winterWolf = new Wolf(); // new object of wolf initialized
